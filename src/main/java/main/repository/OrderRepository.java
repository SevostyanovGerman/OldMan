...
public interface OrderRepository extends JpaRepository <Order, Long> {
	...
	List <Order> findAllByCustomerFirstNameContainsAndDeleted(String name,
															  int deleted);
	List <Order> findAllByDeletedAndNumberContains(int deleted, String number);
	List <Order> findAllByDeletedAndManagerFirstNameContains(int deleted,
															 String name);
	List <Order> findAllByDeletedAndStatusId(int deleted, Long id);
	List <Order> findAllByDeletedAndStatusIdAndNumberContains(int deleted,
															  Long statusId,
															  String number);
	@Query(
